 ...
 * bot. An exception is made for one-time keyboards that are hidden immediately after the user presses a button (see
...
class ReplyKeyboardRemove {
	 ...
	 * removes the keyboard for that user, while still showing the keyboard with poll
